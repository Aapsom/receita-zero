# CONTEXT.md — Glossário do domínio Vitrine Certa (Receita-Zero)

> Glossário puro (ubiquitous language). Zero implementação — decisões técnicas vivem em `docs/adr/`.

- **Vitrine** — site estático de apresentação de uma PME local, publicado a custo R$0 (GitHub Pages).
- **Site DFY** — site "done-for-you": entregue pronto para a PME, sem esforço do cliente.
- **PME-alvo** — negócio local de serviço com recorrência (pizzaria, salão, oficina, lavanderia, padaria, imobiliária — ver PLANO-REDESIGN-*).
...
- **Taste library** — biblioteca curada de referências de design premiadas usada como padrão de qualidade (`taste-library/`).
