...
export { hashPassword, verifyPassword, argon2idConfig } from './argon2id';
// AEAD encryption (XChaCha20-Poly1305 via sodium-native, AES-256-GCM fallback)
export { encrypt, decrypt, generateKey, generateNonce, encryptAESGCM, decryptAESGCM, generateAESGCMKey, generateAESGCMIV, } from './aead';
// Envelope encryption (DEK per record/tenant, wrapped by KEK)
export { encryptEnvelope, decryptEnvelope, generateDEK, wrapDEK, unwrapDEK, generateTenantKeys, encryptForTenant, decryptForTenant, rotateKEK, generateKEK, } from './envelope';
// Blind index for searchable encrypted fields
export { generateBlindIndex, verifyBlindIndex, generateCompositeBlindIndex, blindIndexForSearch, } from './blind-index';
