...
export interface AEADKey {
  key: Buffer;      // 32 bytes (256-bit)
}

export interface EncryptResult {
  ciphertext: Buffer;
  nonce: Buffer;    // 24 bytes for XChaCha20-Poly1305
  tag: Buffer;      // 16 bytes (included in ciphertext for sodium)
}
 ...
 */
export function generateKey(): AEADKey {
 ...
 */
export function generateAESGCMIV(): Buffer {
